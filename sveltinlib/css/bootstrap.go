...
func NewBootstrap(efs *embed.FS, fs afero.Fs, conf *config.SveltinConfig, tplData *config.TemplateData) *Bootstrap {
	return &Bootstrap{
		EFS:    efs,
		FS:     fs,
		Config: conf,
...
func (cssLib *Bootstrap) Setup(isNewProject bool) error {
...
func (cssLib *Bootstrap) makeSveltinStyled(efs *embed.FS, fs afero.Fs, conf *config.SveltinConfig, tplData *config.TemplateData) error {
...
func (cssLib *Bootstrap) makeTheme(efs *embed.FS, fs afero.Fs, conf *config.SveltinConfig, tplData *config.TemplateData) error {
	bootstrapFS := common.UnionMap(resources.SveltinBootstrabLibFS, resources.SveltinBootstrapLibUnstyledFS)
